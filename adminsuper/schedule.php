...
<body>
    ...
    <td>
        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Appointment History</p>
    </td>
    <td width="15%">
        ...
        if (isset($_POST['filter']) && !empty($_POST['sheduledate'])) {
            $selectedDate = $_POST['sheduledate'];
            $sql .= " WHERE datecreated = '$selectedDate'";
        }
        ...
        <center>
            <div class="abc scroll">
                <table width="93%" class="sub-table scrolldown" border="0">
                    <thead>
                        <tr>
                            <th class="table-headin">Appoint Name</th>
                            <th class="table-headin">Category</th>
                            <th class="table-headin">Created Date</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>";
                            echo "<td style='border: 1px solid black; padding: 8px;'>" . htmlspecialchars($row['appointname']) . "</td>";
                            echo "<td style='border: 1px solid black; padding: 8px;'>" . htmlspecialchars($row['category']) . "</td>";
                            echo "<td style='border: 1px solid black; padding: 8px;'>" . htmlspecialchars($row['datecreated']) . "</td>";
                            echo "</tr>";
                        }
                        ?>
                    </tbody>
