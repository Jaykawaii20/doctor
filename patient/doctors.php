                ...
                <tr >
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Staff Specialist name or Email" list="Staff">&nbsp;&nbsp;
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    <div class="popup">
                    <center>
                        <h2>Redirect to Staff SpecialistSS sessions?</h2>
                        <a class="close" href="doctors.php">&times;</a>
                        <div class="content">
