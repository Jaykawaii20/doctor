                ...
                <tr >
                    ...
                    <td >
                            <form action="schedule.php" method="post" class="header-search">
                                        ...
                                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Staff Specialist name or Email or Date (YYYY-MM-DD)" list="doctors" >&nbsp;&nbsp;
                                            ...
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%">
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;line-height:30px">
                                                            Staff specialist:  &nbsp;&nbsp;<b>'.$docname.'</b><br>
