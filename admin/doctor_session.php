    ...
    <div class="container">
        <div class="menu">
            <table class="menu-container" border="0">
                ...
                <a href="Servicehistory.php" class="non-style-link-menu" style="margin: 10px;">Apoointment History</a>
                </td>
                </tr>
                 <tr class="menu-row" >
                    <td class="menu-btn menu-icon-patient">
        ...
        <table width="93%" class="sub-table scrolldown" border="0">
            <thead>
                <tr>
                    ...
                    <th class="table-headin">CS</th>
                    <th class="table-headin">Address</th>
                    <th class="table-headin">Contract Number</th>
                    <th class="table-headin">Religion</th>
                    <th class="table-headin">Date Time</th>
                    <th class="table-headin">Accompanied By</th>
                    <th class="table-headin">Chief Complaints</th>
            ...
            <tbody>
                ...
                // Query to fetch patient history details
                $sql = "
                    SELECT 
                        id, 
                        patient_name, 
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>" . htmlspecialchars($row['cs']) . "</td>";
                    echo "<td>" . htmlspecialchars($row['address']) . "</td>";
                    echo "<td>" . htmlspecialchars($row['contract_number']) . "</td>";
                    echo "<td>" . htmlspecialchars($row['religion']) . "</td>";
                    echo "<td>" . htmlspecialchars($row['date_time']) . "</td>";
                    echo "<td>" . htmlspecialchars($row['accompanied_by']) . "</td>";
                    echo "<td>" . htmlspecialchars($row['chief_complaints']) . "</td>";
                    echo "<td>" . htmlspecialchars($row['history_category']) . "</td>";
                    echo "<td>
