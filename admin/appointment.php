    ...
    <div class="container">
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <td colspan="4">
    <center>
    <div class="abc scroll" style="padding: 20px; border: 2px solid #ccc; border-radius: 8px;">
    <table width="93%" class="sub-table scrolldown" border="0" style="border-collapse: collapse; margin: 0 auto;">
        <thead>
            <tr>
                <th class="table-headin" style="padding: 12px; border-bottom: 1px solid #ddd;">Patient Name</th>
                <th class="table-headin" style="padding: 12px; border-bottom: 1px solid #ddd;">Appointment Number</th>
                <th class="table-headin" style="padding: 12px; border-bottom: 1px solid #ddd;">Session Title</th>
                <th class="table-headin" style="padding: 12px; border-bottom: 1px solid #ddd;">Appointment Date</th>
                <th class="table-headin" style="padding: 12px; border-bottom: 1px solid #ddd;">Status</th>
                <th class="table-headin" style="padding: 12px; border-bottom: 1px solid #ddd;">Actions</th>
            </tr>
        </thead>
                <tbody>
                    <?php
                    ...
                    $sql = "
                        SELECT 
                            ...
                            a.appointmentname AS session_title,
                            a.date AS session_date_time,
                            a.datecreated AS appointment_date,
                            a.status AS status
                        FROM 
                            appointment_patient a
                        JOIN 
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>";
                        echo "<td>" . htmlspecialchars($row['patient_name'] . ' ' . $row['patient_middlename'] . ' ' . $row['patient_lastname']) . "</td>";
                        echo "<td>" . htmlspecialchars($row['appointment_id']) . "</td>";
                        echo "<td>" . htmlspecialchars($row['session_title']) . "</td>";
                        echo "<td>" . htmlspecialchars($row['session_date_time']) . "</td>";
                        echo "<td>" . htmlspecialchars($row['status']) . "</td>";
                       
                        
                        // Add buttons for approving and disapproving
                        echo "<td>
