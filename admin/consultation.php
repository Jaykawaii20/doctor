...
<body>
            ...
            <table border="0" width="100%" style="border-spacing: 0; margin: 0; padding: 0; margin-top: 25px;">
                ...
                <tr>
                    <td colspan="2" style="padding-top:30px;">
                        <p class="heading-main12" style="margin-left: 45px; font-size:20px; color:rgb(49, 49, 49)">Consulation</p>
                    </td>
                    <!-- <td colspan="2" style="padding-top:30px;">
                        ...
                        <center>
                            <div class="abc scroll">
                                <table width="93%" class="sub-table scrolldown" style="border-spacing:20px;">
                                    ...
                                    // Fetch patient data
                                    $sql = "SELECT Id, name, age, sex, address, city, contact, religion, occupation FROM consultation";
    ...
    if ($_GET) {
        $id = $_GET["id"];
        $action = $_GET["action"];
        $sqlmain = "SELECT * FROM consultation WHERE pid='$id'";
